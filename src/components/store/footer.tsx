...
export function Footer() {
  ...
  return (
    <footer className="mt-24 relative overflow-hidden border-t border-[var(--brand-border)]">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-4 py-16 sm:px-6 md:grid-cols-[1.8fr_0.6fr_0.6fr] lg:px-8">
        {/* Coluna 1 — Marca */}
      ...
      <div className="relative border-t border-[var(--brand-border)] bg-black/30 py-6">
        <div className="mx-auto flex max-w-7xl flex-col gap-3 px-4 text-[10px] font-bold uppercase tracking-widest text-[var(--brand-muted)] sm:px-6 md:flex-row md:items-center md:justify-between lg:px-8">
