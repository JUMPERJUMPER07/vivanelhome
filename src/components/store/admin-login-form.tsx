  ...
  return (
    ...
    >
      ...
      <p className="mt-3 text-sm leading-6 text-[var(--brand-muted)]">
        Proteja o cadastro de produtos com senha para editar sua vitrine com mais seguranca.
      </p>

      <label className="mt-6 grid gap-2 text-sm font-semibold text-[var(--brand-text)]">
        Senha do painel
        <input
          type="password"
          value={password}
